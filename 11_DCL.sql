...
CREATE USER ujy_sample IDENTIFIED BY 1234;
...
-- [권한 부여 작성법]
-- GRANT 권한, 권한, ... TO 사용자명;
GRANT CREATE SESSION TO ujy_sample;
...
GRANT CREATE TABLE TO ujy_sample;


ALTER USER ujy_sample DEFAULT TABLESPACE SYSTEM QUOTA UNLIMITED ON SYSTEM;
...
GRANT SELECT ON EMPLOYEE TO ujy_sample;
...
REVOKE SELECT ON EMPLOYEE FROM ujy_sample;
