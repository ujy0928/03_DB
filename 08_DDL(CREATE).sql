...
--   테이블 생성 시 해당 컬럼에 지정된 DEFUALT 값으로 삽입이 된다! *
...
-- ORA-01400: NULL을 ("KH_UJY"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
VALUES(1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1] [23000]: 
-- ORA-00001: 무결성 제약 조건(KH_UJY.USER_ID_U)에 위배됩니다
...
INSERT INTO USER_USED_UK2 
VALUES(1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
--SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_UJY.USER_ID_NAME_U)에 위배됩니다
...
-- 기본키 중복 오류!
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_UJY.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK 
VALUES(NULL, 'USER03', 'PASS03', '유관순', '여자', '010-1212-1111', 'yoo123@kh.or.kr');
-- 기본키 NULL 이므로 오류!
-- ORA-01400: NULL을 ("KH_UJY"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다

INSERT INTO USER_USED_PK 
VALUES(2, 'USER03', 'PASS03', '유관순', '여자', '010-1212-1111', 'yoo123@kh.or.kr');
...
INSERT INTO USER_USED_PK2 
VALUES(1, 'USER02', 'PASS02', '이순신', '남자', '010-1234-5678', 'lee123@kh.or.kr');

INSERT INTO USER_USED_PK2 
VALUES(2, 'USER01', 'PASS02', '이순신', '남자', '010-1234-5678', 'lee123@kh.or.kr');

INSERT INTO USER_USED_PK2 
VALUES(1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_UJY.PK_USERNO_USERID)에 위배됩니다
-- USER_NO, USER_ID 둘 다 중복되었을 때만 제약조건 위배 에러 발생!


INSERT INTO USER_USED_PK2 
VALUES(NULL, 'USER03', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
--  SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_UJY"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다


INSERT INTO USER_USED_PK2 
VALUES(3, NULL, 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_UJY"."USER_USED_PK2"."USER_ID") 안에 삽입할 수 없습니다
...
CREATE TABLE USER_USED_FK(
	...
	-- 테이블 레벨
	--, CONSTRAINT GRADE_CODE_FK FOREIGN KEY(GRADE_CODE) REFFERENCES USER_GRADE
...
-- USER_GRADE(부모테이블/참조테이블)에 30 이라는 GRADE_CODE 가 존재하므로 가능
...
-- ORA-02291: 무결성 제약조건(KH_UJY.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
...
-- SQL Error [2292] [23000]: 
-- ORA-02292: 무결성 제약조건(KH_UJY.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다

-- GRADE_CODE 중 20은 외래키로 참조되고 있지 않으므로 삭제가 가능함.
DELETE FROM USER_GRADE WHERE GRADE_CODE = 20;
SELECT * FROM USER_GRADE;

ROLLBACK; -- 되돌리기.. 20 돌아옴
...
SELECT * FROM USER_USED_FK2; -- 10을 사용하고있던 자식 레코드 값이 NULL이 됨을 확인.


-- 부모테이블인 USER_GRADE2 에서 GRADE_CODE = 10 삭제
--> ON DELETE SET ULL 옵션이 설정되어있어서 오류 없이 삭제됨
...
-- ON DELETE CASCADE 삭제옵션이 적용된 자식 테이블 생성
...
-- 부모 참조키를 사용한 자식 행이 삭제됨을 확인
SELECT * FROM USER_GRADE3;  -- 부모에서 10 삭제됨
SELECT * FROM USER_USED_FK3; -- 부모의 10을 참조하고있던 자식 행 삭제됨
...
VALUES(1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [2290] [23000]: 
-- ORA-02290: 체크 제약조건(KH_UJY.GENDER_CHECK)이 위배되었습니다
