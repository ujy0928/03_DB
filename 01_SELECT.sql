...
/* 컬럼명 AS 별칭 : 별칭 띄어쓰기 x, 특수문자 x, 문자 o
 * 
...
-- EMPLOYEE 테이블에서 (FROM 절)
-- 부서코드가 'D9' 인 사원의 (WHERE 절)
-- 사번, 이름, 부서코드(DEPT_CODE), 직급코드(JOB_CODE)를 조회 (SELECT 절)
...
-- EMPLOYEE 테이블에서 입사일이 1990-01-01 ~ 19990-12-31 사이인 직원의
-- 이름, 입사일 조회
